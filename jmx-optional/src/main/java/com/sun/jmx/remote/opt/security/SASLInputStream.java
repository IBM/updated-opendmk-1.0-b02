...
/**
 * This class is used by clients of the Java SASL that need to create streams
 * using SaslClient's wrap/unwrap.
 */
public class SASLInputStream extends InputStream {

    private int recvMaxBufSize = 65536;
    private final byte[] saslBuffer;           // buffer for storing raw bytes
    ...
    private final InputStream in;              // underlying input stream
    ...
    /**
     * Fills the buf with more data by reading a SASL buffer, unwrapping it, and
     * leaving the bytes in buf for read() to return.
     *
