 ...
 * not forwarded to the wrapped object.</p>
 *
 * <p>
 ...
 * checking behaviour is inappropriate.</p>
 *
 * <p>
...
public abstract class MBeanServerAccessController implements MBeanServerForwarder {
    ...
    private void checkMLetAddURL(ObjectName name, String operationName) throws InstanceNotFoundException {
        SecurityManager sm = System.getSecurityManager();
        if (sm == null && operationName.equals("addURL") && getMBeanServer().isInstanceOf(name, "javax.management.loading.MLet")) {
