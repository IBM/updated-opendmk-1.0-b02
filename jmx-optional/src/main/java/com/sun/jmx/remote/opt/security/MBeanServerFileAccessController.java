 ...
 * request is not forwarded to the wrapped object.</p>
 *
 * <p>
...
public class MBeanServerFileAccessController extends MBeanServerAccessController {
     ...
     * #setMBeanServer} method after doing access checks based on read and write
     * permissions.</p>
     *
     * <p>
     * This instance is initialized from the specified properties file.</p>
     *
     * @param accessFileName name of the file which denotes a properties file on
     * disk containing the username/access level entries.
     *
     ...
     * reading.
     *
     * @exception IllegalArgumentException if any of the supplied access level
     * values differs from "readonly" or "readwrite".
     */
     ...
     * on read and write permissions.</p>
     *
     * <p>
     * This instance is initialized from the specified properties file.</p>
     *
     ...
     * constructor makes a copy of the properties instance using its
    ...
    /**
     * <p>
     * Refresh the set of username/access level entries.</p>
     *
     * <p>
     ...
     * to specify a file from which the entries are read, the file is
     * re-read.</p>
     *
     * <p>
     * If this instance was created using the
