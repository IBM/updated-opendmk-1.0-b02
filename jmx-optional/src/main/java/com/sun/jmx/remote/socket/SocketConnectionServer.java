...
public class SocketConnectionServer implements MessageConnectionServer {
    ...
    public SocketConnectionServer(JMXServiceURL addr, Map<String, Object> env) throws IOException {
...
// implements MessageConnectionServer interface
    public void start(Map<String, Object> env) throws IOException {
        if (logger.traceOn()) {
        ...
        if (o != null && DefaultConfig.getServerReuseAddress(newEnv)) {
            try {
                ...
                ss = (ServerSocket) cc.getDeclaredConstructor().newInstance();
