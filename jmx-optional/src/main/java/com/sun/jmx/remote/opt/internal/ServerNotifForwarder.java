...
public class ServerNotifForwarder {
    ...
    public ServerNotifForwarder(MBeanServer mbeanServer, Map<String, Object> env, NotificationBuffer notifBuffer) {
    ...
    public Integer addNotificationListener(final ObjectName name, final NotificationFilter filter)
        ...
        if (!mbeanServer.isInstanceOf(name, broadcasterClass)) {
    ...
    public void removeNotificationListener(ObjectName name, Integer listenerID)
        ...
        if (name != null && !name.isPattern() && !mbeanServer.isRegistered(name)) {
    ...
    public NotificationResult fetchNotifs(long startSequenceNumber,
        ...
        if (logger.traceOn()) {
            logger.trace("fetchNotifs", "Fetching notifications, the startSequenceNumber is " + startSequenceNumber
                    + ", the timeout is " + timeout + ", the maxNotifications is " + maxNotifications);
        }
    ...
    private final Set<ListenerInfo> listenerList = new HashSet<>();
