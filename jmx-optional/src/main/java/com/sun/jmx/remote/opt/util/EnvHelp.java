...
public class EnvHelp {
     ...
     * value associated with this attribute is a ClassLoader object</p>
     */
     ...
     * <var>env</var> for <tt>jmx.remote.default.class.loader.name</tt>, and
     * registered in <var>mbs</var> if any.
     * </li>
     * <li>
     ...
     * @param mbs The MBeanServer for which the connector server provides remote
     * access.
     *
     ...
     * </li>
     * <li>or
     * <tt>jmx.remote.default.class.loader</tt> is not an instance of
     * {@link ClassLoader},
     * </li>
     * <li>or
     * <tt>jmx.remote.default.class.loader.name</tt> is not an instance of
     * {@link ObjectName},
     * </li>
     * <li>or
     * <tt>jmx.remote.default.class.loader.name</tt> is specified but
     * <var>mbs</var> is null.
     * </li>
     * @exception InstanceNotFoundException if
     * <tt>jmx.remote.default.class.loader.name</tt> is specified and the
     * ClassLoader MBean is not found in <var>mbs</var>.
     */
    public static ClassLoader resolveServerClassLoader(Map<String, Object> env, MBeanServer mbs)
     ...
     * <tt>jmx.remote.default.class.loader</tt> is specified and is not an
    ...
    /**
     * Init the cause field of a Throwable object. The cause field is set only
     * if <var>t</var> has an {@link Throwable#initCause(Throwable)} method (JDK
     * Version >= 1.4)
     *
    ...
    public static Throwable initCause(Throwable t, Throwable cause) {
        /* Make the best effort to set the cause, but if we don't
    ...
    /**
     * Returns the cause field of a Throwable object. The cause field can be got
     * only if <var>t</var> has an {@link Throwable#getCause()} method (JDK
     * Version >= 1.4)
     *
     * @param t Throwable on which the cause must be set.
     ...
     */
    public static int getNotifBufferSize(Map<String, Object> env) {
     ...
     * time.
     */
    public static int getMaxFetchNotifNumber(Map<String, Object> env) {
     ...
     */
    public static long getFetchTimeout(Map<String, Object> env) {
     ...
     *
     * @throws IllegalArgumentException if <code>env</code> contains an entry
     * for <code>name</code> but it does not meet the constraints above.
     */
    ...
    private static void hideAttributes(SortedMap<String, String> map) {
        if (map.isEmpty()) {
            return;
        }
        ...
        String hide = map.get(HIDDEN_ATTRIBUTES);
        if (hide != null) {
            if (hide.startsWith("=")) {
     ...
     */
    public static long getServerConnectionTimeout(Map<String, Object> env) {
     ...
     * client to check its connection. The default value is 60000
     * milliseconds.</p>
     */
