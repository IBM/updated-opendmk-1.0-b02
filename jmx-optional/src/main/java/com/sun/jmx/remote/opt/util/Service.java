...
/**
 * EXTRACTED FROM sun.misc.Service A simple service-provider lookup mechanism. A
 * <i>service</i> is a well-known set of interfaces and
 * (usually abstract) classes. A <i>service provider</i> is a specific
 * implementation of a service. The classes in a provider typically implement
 * the interfaces and subclass the classes defined in the service itself.
 * Service providers may be installed in an implementation of the Java platform
 * in the form of extensions, that is, jar files placed into any of the usual
 * extension directories. Providers may also be made available by adding them to
 ...
 * lines, are ignored. The comment character is <tt>'#'</tt>
...
public final class Service {
     ...
     * already been returned. This set will be updated to contain the names that
     * will be yielded from the returned <tt>Iterator</tt>.
     *
     ...
     *
     * @throws IllegalArgumentException If an I/O error occurs while reading
     * from the given URL, or if a configuration-file format error is detected
     */
    private static Iterator<String> parse(Class service, URL u, Set<String> returned) throws IllegalArgumentException {
        InputStream in = null;
     ...
     * files and instantiate provider classes, or <tt>null</tt> if the system
     * class loader (or, failing that the bootstrap class loader) is to be used
     *
     * @return An <tt>Iterator</tt> that yields provider objects for the given
     * service, in some arbitrary order. The iterator will throw a
     * <tt>IllegalArgumentException</tt> if a provider-configuration file
     * violates the specified format or if a provider class cannot be found and
     * instantiated.
     *
     * @throws IllegalArgumentException If a provider-configuration file
     * violates the specified format or names a provider class that cannot be
