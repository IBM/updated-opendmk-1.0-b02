...
/**
 * <p>
 * This class represents an error that occurred during the various client/server
 * handshake exchanges.</p>
 *
 * <p>
 * At any time during the handshake, if either the client or the server
...
public class HandshakeErrorMessage implements Message {
     ...
     *
     * @param detail a textual description of the error encountered by the peer
     * object.
     */
