...
/**
 * <p>
 * A challenge or response exchanged between client and server during SASL
 * authentication. This message encapsulates either a challenge or a response
 * generated by the SASL mechanism during the SASL authentication exchanges
 * taking place between the client and the server.</p>
 *
 * <p>
 ...
 * mechanisms.</li>
 * <li>The <b>responses</b> are generated by the client side SASL mechanisms in
 * response to the server challenges.</li>
 * </ul>
 * The status attribute takes one of the two values:
 * <ul>
 * <li><b>CONTINUE</b>: used by either a client or server to indicate that they
 * require more interaction with the other peer in order to complete the
 * authentication exchange.</li>
 ...
 * <p>
 * The profile name in this profile message is built by concatenating the prefix
 * "SASL/" with the SASL mechanism name provided by the IANA SASL registry.
 * <p>
...
public class SASLMessage implements ProfileMessage {
    ...
    /**
     * Constructs a new SASLMessage with the specified SASL mechanism, status
     * and generated blob.
     *
