...
public class CloseMessage implements Message {
     ...
     *
     * @param msg a user specific message explaining why the connection was
    ...
    /**
     * Returns a message explaining why the connection was closed by the remote
     * side.
     *
     * @return a message explaining why the connection was closed by the remote
     * side.
     */
