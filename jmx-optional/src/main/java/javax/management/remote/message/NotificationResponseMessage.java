...
/**
 * <p>
 * Message that transports one or more notifications emitted from an MBean
 * server through a connector server to listeners in a remote client.</p>
 *
 * <p>
 * This message is sent from a server to a client in response to a previous
 * {@link NotificationRequestMessage} from the client.</p>
 */
public class NotificationResponseMessage implements Message {
     ...
     * This is a {@link NotificationResult} object wrapped using the
     * {@link ObjectWrapping} for the connection using this message.
     *
     * @exception NullPointerException if <code>wrappedNotificationResult</code>
     * is null.
     */
     ...
     *
     * @return an object that wraps a {@link NotificationResult} using the
     * {@link ObjectWrapping} for the connection using this message.
     *
     */
