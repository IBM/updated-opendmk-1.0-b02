...
class ClientIntermediary {
    ...
    public ClientIntermediary(ClientSynchroMessageConnection connection, ObjectWrapping wrap, GenericConnector client, Map<String, ?> env) {
    ...
    public ObjectInstance createMBean(String className, ObjectName name, Subject delegationSubject) throws ReflectionException,
        ...
        try {
            return (ObjectInstance) mBeanServerRequest(MBeanServerRequestMessage.CREATE_MBEAN,
                    new Object[]{className, name}, delegationSubject);
    ...
    public AttributeList setAttributes(ObjectName name,
        ...
        try {
            ...
            return (AttributeList) mBeanServerRequest(MBeanServerRequestMessage.SET_ATTRIBUTES,
                    new Object[]{name, wrappedAttrs}, delegationSubject);
        } catch (InstanceNotFoundException | ReflectionException e) {
            throw e;
        } catch (Exception e) {
            throw appropriateException(e);
    ...
    public MBeanInfo getMBeanInfo(ObjectName name,
        ...
        try {
            return (MBeanInfo) mBeanServerRequest(MBeanServerRequestMessage.GET_MBEAN_INFO,
                    new Object[]{name}, delegationSubject);
    ...
    public boolean isInstanceOf(ObjectName name, String className, Subject delegationSubject)
        ...
        try {
            return (Boolean) mBeanServerRequest(MBeanServerRequestMessage.IS_INSTANCE_OF,
                    new Object[]{name, className}, delegationSubject);
        } catch (InstanceNotFoundException e) {
            throw e;
        } catch (Exception e) {
            throw appropriateException(e);
    ...
    private Integer addListenerWithSubject(ObjectName name, Object wrappedFilter, Subject delegationSubject,
    ...
    public void addNotificationListener(ObjectName name, ObjectName listener, NotificationFilter filter, Object handback,
        ...
        try {
            ...
            mBeanServerRequest(code, new Object[]{name, listener, serialization.wrap(filter), serialization.wrap(handback)},
                    delegationSubject);
        } catch (InstanceNotFoundException e) {
            throw e;
        } catch (Exception e) {
...
//----------------------------------------------
    ...
    private class GenericClientCommunicatorAdmin extends ClientCommunicatorAdmin {
        ...
        protected void checkConnection() throws IOException {
            try {
                ...
                // see  6496038
                logger.trace("GenericClientCommunicatorAdmin-checkConnectionTimeout?", irie);
    ...
    private class GenericClientNotifForwarder extends ClientNotifForwarder {
        ...
        protected void removeListenerForMBeanRemovedNotif(Integer id) throws IOException {
            ...
            logger.trace("GenericClientNotifForwarder-removeListenerForMBeanRemovedNotif",
        ...
        protected void lostNotifs(String message, long number) {
            ...
            final JMXConnectionNotification n = new JMXConnectionNotification(notifType,
                            ClientIntermediary.this, connection.getConnectionId(), lostNotifCounter++, message, number);
