...
/**
 * <p>
 * A client connection to a remote JMX API server. This class can use a
 * {@link MessageConnection} object to specify the transport for communicating
 * with the server.</p>
 *
 * <p>
 ...
 * specified by attributes in the <code>Map</code> passed to the constructor or
 * the {@link #connect(Map) connect} method. The attribute
 * {@link #MESSAGE_CONNECTION} is the standard way to define the transport. An
...
public class GenericConnector implements JMXConnector {
    ...
    /**
     * <p>
     * Name of the attribute that specifies how this connector sends messages to
     * its connector server. The value associated with this attribute, if any,
     * must be an object that implements the interface
     * {@link MessageConnection}.</p>
     */
    ...
    /**
     * <p>
     * Constructor specifying connection attributes.</p>
     *
     * @param env the attributes of the connection.
     *
     */
    public GenericConnector(Map<String, ?> env) {
        // ------------------------------------------------------------
        //  WARNING - WARNING - WARNING - WARNING - WARNING - WARNING 
        // ------------------------------------------------------------
    ...
    public void connect(Map<String, ?> env) throws IOException {
        ...
        synchronized (lock) {
            ...
            final Map<String, Object> tmpEnv = new HashMap<>((this.env == null) ? Collections.EMPTY_MAP : this.env);
    ...
    /**
     * <p>
     * Send a notification to the connection listeners. The notification will be
     * sent to every listener added with {@link
     * #addConnectionNotificationListener
     * addConnectionNotificationListener} that was not subsequently removed by a
     * <code>removeConnectionNotificationListener</code>, provided the
     * corresponding {@link NotificationFilter} matches.</p>
     *
     * @param n the notification to send. This will usually be a
     * {@link JMXConnectionNotification}, but an implementation can send other
...
// -------------------------------------------------
    /**
     * Called by a ClientIntermediary to reconnect the transport because the
     * server has been closed after its timeout.
     */
...
// -------------------------------------------------
    ...
    private transient final int[] lock;
